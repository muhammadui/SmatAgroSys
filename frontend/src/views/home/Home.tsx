        ...
        <div className="container">
          <div className="home_nav_wrapper">
            ...
            <div className="home_nav_right">
              <a href="#contact" className="link mr">
                Contact
              </a>
              <Link className="link border_gray mr" to="/auth/login">
                Login
              </Link>
              <Link className="link btn_bg" to="#">
                Get Started
              </Link>
      ...
      <div className="home_section">
        ...
        <div className={`mobile_section ${toggler ? "show" : ""}`}>
          <div className="links_wrapper">
            <a href="#contact" className="link mr mb2">
              Contact
            </a>
            <Link className="link mr mb2" to="/auth/login">
              Login
            </Link>
            <Link className="link border_white" to="#">
              Get Started
            </Link>
          </div>

          <div className="close_btn" onClick={() => setToggler(false)}>
            X
          </div>
        </div>
        ...
        <div className="container">
          ...
          <div className="banner_section">
            <div className="banner_left">
              ...
              <p>
                SmatAgro is a tech driven solution to empower local farmers
                leading to food security, higher crop yields, climate-smart &
              ...
              <div className="flex_start_center mt2">
                <button className="btn_bg btn_big mr2">
                  ...
                  <span className="arrow">
                    ...
                    >
                      <path
                        d="M12.5391 2.6543L21 8.99995L12.5391 15.3456"
                        strokeWidth="1.5"
                        strokeLinecap="round"
          ...
          <div className="about_section">
            ...
            <p className="p_center">
              Better quality produce, smart farming and access to market by
              engaging our local farmers with professionals through a gamified
            ...
            <div className="cards">
              <div className="card">
                <div className="card_image">
                  <img src={farm_magnt_icon} alt="Icon" />
                </div>
                <h4 className="card_title">Farm Management</h4>
                <p className="card_content">
                  Organize and manage all your farms in one place, with an
                  intuitive tools for tracking planting schedules, crop
                  rotations, harvesting & after harvest.
                </p>
              </div>

              <div className="card">
                <div className="card_image">
                  <img src={farmers_connect_icon} alt="Icon" />
=======
    ...
    return (
        <>
            ...
            <nav className="home_nav">
                <div className="container">
                    <div className="home_nav_wrapper">
                        <div className="home_nav_left flex_start_center">
                            <div className="logo mr">
                                <svg width="512" height="512" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect width="512" height="512" rx="256" fill="#0C7E46"/>
                                    <path fillRule="evenodd" clipRule="evenodd" d="M150.048 255.933C150.048 197.678 197.678 150.048 255.933 150.048H361.817V255.937C361.817 314.192 314.192 361.817 255.937 361.817H178.996C209.02 298.719 264.236 215.616 342.297 179.637C267.355 195.227 193.556 250.623 150.057 315.209V255.933H150.048ZM400.87 111H255.937C176.236 111 111 176.236 111 255.933V400.87H255.933C335.629 400.87 400.87 335.634 400.87 255.937V111Z" fill="white"/>
                                </svg>
                            </div>
                            <span className="mr" style={{fontWeight: "bold", fontSize: "1.2rem"}}>SmatAgrosys</span>
                        </div>
...
>>>>>>> 6acfb365c3c7bdb1d21d8cde027d2d6235b8d30a
                </div>
                <h4 className="card_title">Farmers Connect</h4>
                <p className="card_content">
                  Connect with other farmers and professionals from and outside
                  your community to share resources with our social forum and
                  earn a recognition.
                </p>
              </div>
              ...
              <div className="card">
                <div className="card_image">
                  <img src={growth_tracking_icon} alt="Icon" />
                </div>
                <h4 className="card_title">Growth Tracking</h4>
                <p className="card_content">
                  Monitor the growth of your crops, activities and stay updated
                  on their health status with our easy-to-use and simple
                  tracking tools.
                </p>
              </div>
              ...
              <div className="card">
                <div className="card_image">
                  <img src={martket_place_icon} alt="Icon" />
                </div>
                <h4 className="card_title">Marketplace</h4>
                <p className="card_content">
                  Talk about Buy and sell crops and other agricultural products
                  directly, Connect with local markets & whole sellers to expand
                  your business and make more profits.
                </p>
              </div>

              <div className="card">
                <div className="card_image">
                  <img src={expert_advice_icon} alt="Icon" />
                </div>
                <h4 className="card_title">Expert Advice</h4>
                <p className="card_content">
                  Connect with agric- extension officers to receive personalized
                  recommendations for your crops and real time decision support
                  based on your specific growing conditions and challenges.
                </p>
              </div>

              <div className="card">
                <div className="card_image">
                  <img src={auto_reminders_icon} alt="Icon" />
                </div>
                <h4 className="card_title">Auto Reminders</h4>
                <p className="card_content">
                  Never miss a task or important date, with our AI powered
                  reminders you will keep track of what need to be done and stay
            ...
            <div className="create_account_wrapper">
              <div className="account_content">
                <div>
                  ...
                  <ul>
                    <li>
                      <span className="li_icon"></span>{" "}
                      <span>Interaction design</span>
                    </li>
                    <li>
                      <span className="li_icon"></span>{" "}
                      <span>Finding and managing</span>
                    </li>
                    <li>
                      <span className="li_icon"></span>{" "}
                  ...
                  <div className="flex_start_center mt2">
                    ...
                    <button className="btn_outline btn_big">
                      Talk to sales
                    </button>
                  </div>
                </div>
              ...
              <div className="account_image">
                <img src={create_account} alt="Image" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="container">
            <div className="problem_wrapper">
              <div className="pro_image">
                <img src={problem_to_solve} alt="Image" />
              </div>
              ...
              <div className="pro_content">
                ...
                <p>
                  Lack of access to up-to-date information on crop cultivation &
                  harvesting, pest management, adopting new techniques and
                  expert advise this result in increasing the risk of crop
                  failure and reducing yields and poor-quality produce among
                  local farmers.
                </p>
              </div>
            </div>
        ...
        <div className="download_section">
          <div className="container">
            <div className="card_wrapper">
              <div className="card">
                <h2>
                  Download our app for iOS <br />
                  and iPadOS
                </h2>
                <p>Click the button below to download our app directly.</p>
            ...
            <div className="contact_wrapper">
              <div className="content">
                ...
                <p>
                  ...
                  our platform, want to share feedback, or just want to say
                ...
                <div className="flex_start_center mt2">
                  <span className="arrow mr">
                    ...
                    >
                      <path
                        d="M17.6667 3.08337V11.4167C17.6667 11.9692 17.4472 12.4991 17.0565 12.8898C16.6658 13.2805 16.1359 13.5 15.5833 13.5H3.08333C2.5308 13.5 2.00089 13.2805 1.61019 12.8898C1.21949 12.4991 1 11.9692 1 11.4167V3.08337"
                        stroke="#4F4F4F"
                        strokeWidth="1.4"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                      <path
                        d="M17.6667 3.08333C17.6667 2.5308 17.4472 2.0009 17.0565 1.61019C16.6658 1.21949 16.1359 1 15.5833 1H3.08333C2.5308 1 2.00089 1.21949 1.61019 1.61019C1.21949 2.0009 1 2.5308 1 3.08333L8.22917 7.59722C8.56027 7.80417 8.94288 7.91389 9.33333 7.91389C9.72379 7.91389 10.1064 7.80417 10.4375 7.59722L17.6667 3.08333Z"
                        stroke="#4F4F4F"
                        strokeWidth="1.4"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                ...
                <div className="flex_start_center mt2">
                  <span className="arrow mr">
                    ...
                    >
                      <path
                        d="M14.7215 8.28956C14.7215 13.6684 9.21233 16.9821 8.06744 17.6133C8.00402 17.6483 7.93277 17.6667 7.86033 17.6667C7.7879 17.6667 7.71665 17.6483 7.65322 17.6133C6.50748 16.9821 1 13.6684 1 8.28956C1 4.00158 3.57279 1 7.86076 1C12.1487 1 14.7215 4.00158 14.7215 8.28956Z"
                        stroke="#4F4F4F"
                        strokeWidth="1.4"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                  ...
                  <span>794 Murtala Mohd St Bauchi Nigeria, 94102.</span>
                </div>
              </div>
...
<<<<<<< HEAD
                ...
                <div
                  className="flex_start_center mt2"
                  style={{ flexWrap: "wrap" }}
                >
                  {/* Facebook */}
