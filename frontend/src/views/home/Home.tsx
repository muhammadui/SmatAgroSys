              ...
              <div className="logo mr">
                ...
                >
                  ...
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M150.048 255.933C150.048 197.678 197.678 150.048 255.933 150.048H361.817V255.937C361.817 314.192 314.192 361.817 255.937 361.817H178.996C209.02 298.719 264.236 215.616 342.297 179.637C267.355 195.227 193.556 250.623 150.057 315.209V255.933H150.048ZM400.87 111H255.937C176.236 111 111 176.236 111 255.933V400.87H255.933C335.629 400.87 400.87 335.634 400.87 255.937V111Z"
                    fill="white"
                  />
                </svg>
              </div>
